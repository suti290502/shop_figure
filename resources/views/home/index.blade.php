   ...
   <body>
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="custom_menu">
                        <ul>
                           <li><a href="{{ asset('#')}}">Best Sellers</a></li>
                           <li><a href="{{ asset('#')}}">Gift Ideas</a></li>
                           <li><a href="{{ asset('#')}}">New Releases</a></li>
                           <li><a href="{{ asset('#')}}">Today's Deals</a></li>
            ...
            <div class="container">
               <div class="containt_main">
                  <div id="mySidenav" class="sidenav">
                     ...
                     <a href="{{ asset('fashion.html')}}">Fashion</a>
                     <a href="{{ asset('electronic.html')}}">Electronic</a>
                     <a href="{{ asset('jewellery.html')}}">Jewellery</a>
                  </div>
                  ...
                  <div class="header_box">
                     <div class="lang_box ">
                        <a href="{{ asset('#" title="Language" class="nav-link" data-toggle="dropdown" aria-expanded="true')}}">
         ...
         <div class="banner_section layout_padding">
            <div class="container">
               <div id="my_slider" class="carousel slide" data-ride="carousel">
                     ...
                     <div class="carousel-item active">
                        <div class="row">
                           <div class="col-sm-12">
                              ...
                              <div class="buynow_bt"><a href="{{ asset('#')}}">Buy Now</a></div>
                           </div>
                        </div>
                     </div>
                  ...
                  <a class="carousel-control-prev" href="{{ asset('#my_slider" role="button" data-slide="prev')}}">
                  <i class="fa fa-angle-left"></i>
                  </a>
                  <a class="carousel-control-next" href="{{ asset('#my_slider" role="button" data-slide="next')}}">
      ...
      <div class="fashion_section">
         <div id="main_slider" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="row">
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 ...
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="{{ asset('#')}}">Buy Now</a></div>
                                    <div class="seemore_bt"><a href="{{ asset('#')}}">See More</a></div>
                                 </div>
                              </div>
                           </div>
                           <div class="col-lg-4 col-sm-4">
            ...
            <a class="carousel-control-next" href="{{ asset('#main_slider" role="button" data-slide="next')}}">
            <i class="fa fa-angle-right"></i>
            </a>
         </div>
      </div>
      ...
      <div class="fashion_section">
         <div id="electronic_main_slider" class="carousel slide" data-ride="carousel">
            ...
            <a class="carousel-control-prev" href="{{ asset('#electronic_main_slider" role="button" data-slide="prev')}}">
            <i class="fa fa-angle-left"></i>
            </a>
            <a class="carousel-control-next" href="{{ asset('#electronic_main_slider" role="button" data-slide="next')}}">
            <i class="fa fa-angle-right"></i>
            </a>
         </div>
      </div>
      ...
      <div class="jewellery_section">
         <div id="jewellery_main_slider" class="carousel slide" data-ride="carousel">
            ...
            <a class="carousel-control-prev" href="{{ asset('#jewellery_main_slider" role="button" data-slide="prev')}}">
            <i class="fa fa-angle-left"></i>
            </a>
            <a class="carousel-control-next" href="{{ asset('#jewellery_main_slider" role="button" data-slide="next')}}">
            <i class="fa fa-angle-right"></i>
            </a>
      ...
      <div class="footer_section layout_padding">
         <div class="container">
            <div class="footer_logo"><a href="{{ asset('index.html')}}"><img src="images/footer-logo.png"></a></div>
            <div class="input_bt">
               <input type="text" class="mail_bt" placeholder="Your Email" name="Your Email">
               <span class="subscribe_bt" id="basic-addon2"><a href="{{ asset('#')}}">Subscribe</a></span>
            </div>
            ...
            <div class="location_main">Help Line  Number : <a href="{{ asset('#')}}">+1 1800 1200 1200</a></div>
         </div>
      </div>
      <!-- footer section end -->
      ...
      <div class="copyright_section">
         <div class="container">
            <p class="copyright_text">© 2020 All Rights Reserved. Design by <a href="{{ asset('https://html.design')}}">Free html  Templates</a></p>
         </div>
      </div>
